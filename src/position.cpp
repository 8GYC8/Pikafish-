...
// SkyRule couples to rule120 and YitianRule couples to rule140; selecting any
// of AsianRule/SkyRule/YitianRule switches the Sixty Move Rule on (enforced
// in engine.cpp couplings).
...
bool Position::rule_judge(Value& result, int ply) {
    ...
    // on for AsianRule/SkyRule/YitianRule (the user may still turn it off manually).
